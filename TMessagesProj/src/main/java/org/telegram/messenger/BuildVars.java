...
public class BuildVars {
    ...
    public static int APP_ID = 16364107;
    public static String APP_HASH = "13364bbcfc2fddde1e1cba6fd0518f1e";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.telegram.kkgosu.messenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
